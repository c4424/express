...
* If you finish early, feel encouraged to work on any one of these additional tasks to take your application to the next level.
...
* Use vanilla javascript to run AJAX calls to GET and POST data from users to the Express server
